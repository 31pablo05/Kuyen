...
const ModalCarrito = ({ 
  ...
  {/* Contenido del carrito con scroll visible */}
  <div className="flex-1 p-6 overflow-y-scroll scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-blue-50" style={{ minHeight: '200px', maxHeight: '45vh' }}>
          {carrito.length === 0 ? (
            <div className="text-center py-12">
              ...
              <button
                onClick={cerrarModal}
                className="bg-[#2B4C7E] hover:bg-[#1e3557] text-white px-6 py-3 rounded-lg font-bold transition-colors"
              >
                Explorar Productos
              </button>
            </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        <span className="bg-[#2B4C7E] text-white px-2 py-1 rounded-md text-xs font-medium">
                          {item.categoria}
                        </span>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex items-center border border-gray-300 rounded-lg">
                            ...
                            <span className="px-4 py-1 bg-gray-50 font-bold text-[#2B4C7E] min-w-[3rem] text-center">
                              {item.cantidad}
                            </span>
                            <button
                              onClick={() => actualizarCantidad(item.id, item.cantidad + 1)}
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-bold text-lg text-[#2B4C7E]">
        ...
        {carrito.length > 0 && (
          <div className="border-t bg-gradient-to-r from-gray-50 to-blue-50 p-6">
            ...
            <div className="bg-white rounded-lg p-4 mb-4 shadow-sm">
              <div className="grid grid-cols-2 gap-4 mb-3">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-[#2B4C7E]">{cantidadTotal}</p>
                </div>
              </div>
              ...
              <div className="border-t pt-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-bold text-[#2B4C7E] bg-gradient-to-r from-blue-50 to-green-50 px-4 py-2 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                onClick={cerrarModal}
                className="flex-1 bg-white hover:bg-gray-50 text-gray-700 border-2 border-gray-300 py-3 px-6 rounded-lg font-bold transition-colors flex items-center justify-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                onClick={abrirPedido}
                className="flex-2 bg-gradient-to-r from-[#25D366] to-[#20BA5A] hover:from-[#20BA5A] hover:to-[#1ba94a] text-white py-3 px-6 rounded-lg font-bold transition-all shadow-lg flex items-center justify-center gap-2"
              >
