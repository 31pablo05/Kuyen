      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0">
            <a href="/" className="flex items-center gap-3 group">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-[#F8FAFC] to-white p-2 rounded-xl border border-[#5DA9E9]/20 shadow-lg group-hover:shadow-xl transition-all duration-300">
                  <img 
                    src="/assets/logo/5.png" 
                    alt="Kuyen Logo" 
                    className="h-12 w-auto transition-all duration-300 group-hover:scale-110 filter group-hover:brightness-110"
                  />
                </div>
              </div>
              <div className="hidden sm:block">
                <div className="flex flex-col">
                  <span className="text-2xl font-black bg-gradient-to-r from-[#5DA9E9] via-[#2B4C7E] to-[#5DA9E9] bg-clip-text text-transparent group-hover:from-[#4A90E2] group-hover:to-[#1A365D] transition-all duration-300">
                    Kuyen
                  </span>
                  <div className="flex items-center gap-1 -mt-1">
                    <span className="text-xs text-[#2B4C7E]/70 font-medium">Blanquería Premium</span>
          ...
          <div className="hidden md:flex items-center">
            <a 
              href="/productos" 
              className="relative inline-flex items-center gap-2 bg-gradient-to-r from-[#5DA9E9] via-[#2B4C7E] to-[#5DA9E9] hover:from-[#4A90E2] hover:via-[#1A365D] hover:to-[#4A90E2] text-white px-6 py-3 rounded-full font-bold transition-all duration-500 transform hover:scale-105 shadow-lg hover:shadow-2xl overflow-hidden group"
            >
        ...
        <div className={`md:hidden transition-all duration-500 ease-in-out ${
          ...
          <div className="mt-4 bg-gradient-to-br from-white to-[#F8FAFC] rounded-2xl shadow-xl border border-[#5DA9E9]/20 overflow-hidden">
            
            {/* Mobile user section */}
            <div className="bg-gradient-to-r from-[#5DA9E9]/10 to-[#9AE6B4]/10 p-4 border-b border-[#F5F5F5]">
            ...
            <div className="p-2">
              {navLinks.map((link, index) => (
                <a 
                  key={link.href}
                  href={link.href} 
                  className={`flex items-center gap-3 px-4 py-3 mx-2 my-1 rounded-xl transition-all duration-300 ${
                    activeLink === link.href 
            ...
            {/* Mobile CTA Button */}
            <div className="p-4 bg-gradient-to-r from-[#F8FAFC] to-white border-t border-[#F5F5F5]">
              <a 
                href="/productos" 
                className="block w-full bg-gradient-to-r from-[#5DA9E9] via-[#2B4C7E] to-[#5DA9E9] text-white text-center px-6 py-4 rounded-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-lg relative overflow-hidden group"
